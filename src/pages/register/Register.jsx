...
const Register = () => {
    ...
    // การเรียกใช้ react hook form
    const { register,handleSubmit,reset,errors} = useForm()

    // สร้างฟังก์ชัน่รับข้อมูลไปใช้
    ...
    return (
        <AuthLayout title="Register">
            ...
            <div className="col-md-8">
                ...
                />
                {errors.fullname && <p className="error">กรุณากรอกชื่อ</p>}
            </div>
            </div>
            ...
            <div className="col-md-8">
                ...
                ref={register({required: true})}
                />
                {errors.email && <p className="error">กรุณากรอกอีเมล์</p>}
            </div>
            </div>
            ...
            <div className="col-md-8">
                ...
                ref={register({required: true})}
                />
                {errors.username && <p className="error">กรุณากรอกชื่อผู้ใช้</p>}
            </div>
            </div>
            ...
            <div className="col-md-8">
                ...
                ref={register({required: true})}
                />
                {errors.password && <p className="error">กรุณากรอกรหัสผ่าน</p>}
            </div>
            </div>
